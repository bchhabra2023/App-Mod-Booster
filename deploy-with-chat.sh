...
# Deployment script for Expense Management System with GenAI
# This script deploys the infrastructure, application, AND GenAI resources

set -e  # Exit on error

echo "======================================"
echo "Expense Management System Deployment"
echo "WITH GenAI Resources (Chat Feature)"
echo "======================================"
echo ""
...
echo "🚀 Deploying infrastructure (App Service, Managed Identity, Azure SQL, Azure OpenAI, AI Search)..."
...
echo ""
echo "💬 AI Chat: Click the 'AI Chat Assistant' button in the app"
echo ""
echo "📝 To run the app locally:"
echo "   1. Update src/ExpenseManagement/appsettings.json with:"
echo "      - Connection string with 'Authentication=Active Directory Default'"
echo "      - OpenAI__Endpoint: $OPENAI_ENDPOINT"
echo "      - OpenAI__DeploymentName: $OPENAI_MODEL_NAME"
echo "   2. Run 'az login' before starting the app"
echo "   3. Run 'dotnet run' from src/ExpenseManagement directory"
echo ""
echo "🎉 Your AI-powered Expense Management System is ready!"
echo ""
