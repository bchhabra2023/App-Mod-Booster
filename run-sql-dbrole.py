...
"""
run-sql-dbrole.py
Assigns the managed identity as a database user with db_datareader,
db_datawriter, and EXECUTE permissions on Azure SQL Database.
Uses Azure AD token authentication via AzureCliCredential.
"""
import pyodbc
import struct
